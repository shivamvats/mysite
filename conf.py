...
BLOG_AUTHOR = "Shivam Vats"  # (translatable)
BLOG_TITLE = "My Rhapsody"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://shivamvats.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://shivamvats.github.io/"
BLOG_EMAIL = "shivamvats.iitkgp@gmail.com"
BLOG_DESCRIPTION = "My time capsule."  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "aries-will-blog"
